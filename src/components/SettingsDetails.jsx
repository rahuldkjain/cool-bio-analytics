...
import {
  GET_PROJECT_DETAILS_BY_ID_FOR_SETTINGS
...
function SettingsDetails ({ projectId }) {
  ...
  const { loading, error, data = {} } = useQuery(GET_PROJECT_DETAILS_BY_ID_FOR_SETTINGS, {
    variables: {
      projectId
    }
  })
  ...
  return (
    error
      ? <x.div
              py={8}
              color="red"
          >There was an error. Reload the page!</x.div>
      : <x.div>
            <x.div
                py={8}
            >
                ...
                <x.p color="gray" mb={5}>Edit or change details.</x.p>
                {loading
            ...
            >
                ...
                <x.p color="gray">Your personal account is on the HOBBY plan. Free of charge..</x.p>
                <x.div pt={8} maxWidth={800}>
                    <x.button bg="blueLight"
                        color="blue"
                        borderRadius="5px"
                        py={3}
                        px={6}
