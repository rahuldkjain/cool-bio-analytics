    ...
    <PrivateRoute>
      ...
      <AppWrapper>
        <HomeLeft>
          ...
          <CountryCount
            projectId={name}
            query={GET_SESSIONS_COUNT_WITH_COUNTRY}
            columns={countryColumns}
          />
          <CountryCount
            projectId={name}
            query={GET_SESSIONS_COUNT_WITH_CLIENT_NAME}
            columns={browserColumns}
          />
          <CountryCount
            projectId={name}
            query={GET_SESSIONS_COUNT_WITH_PAGES}
            columns={pagesColumns}
          />
          <CountryCount
            projectId={name}
            query={GET_SESSIONS_COUNT_WITH_REFERRER}
